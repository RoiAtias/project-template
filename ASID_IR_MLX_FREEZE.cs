...
string components = SensorID1 ,SensorID2
string params = "DspErrorBits","DspStatusFlags","High limit value","Actual Value "
...
code enalysis in .net



1. למפות את השדות עם שליו
2. לוקאליזציה האם אתה רוצה את זה
